...
# Import modality-related constants from cfg module for RGB+X framework
try:
    from ultralytics.cfg import COMMON_MODALITIES
except ImportError:
    # Fallback if cfg module not available - provide common modality examples
